...
zss_editor.insertImagebylocal = function(url, alt,w,h) {
    zss_editor.restorerange();
    //    width="161" height="30"
    var html = '<div align="center"><img src="'+url+'" alt="'+alt+'" data-width="'+w+'" data-height="'+h+'"/></div>';
...
zss_editor.insertImage = function(url, alt) {
    zss_editor.restorerange();
    var html = '<div align="center"><img src="'+url+'" alt="'+alt+'" imagesizesssssss/></div>';
    zss_editor.insertHTML(html);
    zss_editor.enabledEditingItems();
}
