...
@property (nonatomic, assign) float exhight;
...
static CGFloat kDefaultScale = 0.1;
...
- (void)viewDidLoad {
    ...
    CGRect frame = CGRectMake(0, self.exhight, self.view.frame.size.width, self.view.frame.size.height-self.exhight);
...
- (void)insertImagebylocal:(NSString *)url alt:(NSString *)alt w:(float)w h:(float)h
{
    NSString *trigger = [NSString stringWithFormat:@"zss_editor.insertImagebylocal(\"%@\", \"%@\", \"%f\", \"%f\");", url, alt,w,h];
    [self.editorView stringByEvaluatingJavaScriptFromString:trigger];
...
- (void)keyboardWillShowOrHide:(NSNotification *)notification {
    ...
    if ([notification.name isEqualToString:UIKeyboardWillShowNotification]) {
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
            ...
            editorFrame.size.height = (self.view.frame.size.height - keyboardHeight) - sizeOfToolbar - extraHeight-self.exhight;
            ...
            sourceFrame.size.height = (self.view.frame.size.height - keyboardHeight) - sizeOfToolbar - extraHeight-self.exhight;
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
            ...
            if (_alwaysShowToolbar) {
                editorFrame.size.height = ((self.view.frame.size.height - sizeOfToolbar-self.exhight) - extraHeight);
            } else {
                editorFrame.size.height = self.view.frame.size.height-self.exhight;
            }
            ...
            if (_alwaysShowToolbar) {
                sourceFrame.size.height = ((self.view.frame.size.height - sizeOfToolbar-self.exhight) - extraHeight);
            } else {
                sourceFrame.size.height = self.view.frame.size.height-self.exhight;
            }
